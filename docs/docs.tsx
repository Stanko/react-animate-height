...
> {
  ...
  render() {
    const { height, height2, height3, delay } = this.state;
      ...
      <div>
        ...
        <div className="buttons">
          ...
          <button
            type="button"
            className="btn btn-sm"
            onClick={() => this.setState({ height: 200 })}
          >
            200
          </button>
          <button
            type="button"
            className="btn btn-sm"
            onClick={() => this.setState({ height: 300 })}
          >
            300
          </button>
          <button
            type="button"
            className="btn btn-sm"
            onClick={() => this.setState({ height: "auto" })}
          >
            auto
          </button>
        </div>
        <AnimateHeight height={height} className="demo demo-1">
        ...
        <div className="buttons">
          <button
            type="button"
            className="btn btn-sm"
            onClick={() => this.setState({ height2: 0 })}
          >
            0
          </button>
          <button
            type="button"
            className="btn btn-sm"
            onClick={() => this.setState({ height2: 100 })}
          >
            100
          </button>
          <button
            type="button"
            className="btn btn-sm"
            onClick={() => this.setState({ height2: 200 })}
          >
            200
          </button>
          <button
            type="button"
            className="btn btn-sm"
            onClick={() => this.setState({ height2: 300 })}
          >
            300
          </button>
          <button
            type="button"
            className="btn btn-sm"
            onClick={() => this.setState({ height2: "auto" })}
          >
            auto
          </button>
        </div>
        <AnimateHeight
          ...
          onAnimationEnd={(params) => {
            console.log("React Animate Height - animation ended", params);
          }}
        ...
        <div className="buttons">
          ...
          <button
            type="button"
            className="btn btn-sm"
            onClick={() => this.setState({ delay: 600 })}
          >
            600
          </button>
          <button
        ...
        <div className="buttons">
          <button
            type="button"
            className="btn btn-sm"
            onClick={() => this.setState({ height3: 0 })}
          >
            0
          </button>
          <button
            type="button"
            className="btn btn-sm"
            onClick={() => this.setState({ height3: 100 })}
          >
            100
          </button>
          <button
            type="button"
            className="btn btn-sm"
            onClick={() => this.setState({ height3: 200 })}
          >
            200
          </button>
          <button
            type="button"
            className="btn btn-sm"
            onClick={() => this.setState({ height3: 300 })}
          >
            300
          </button>
          <button
            type="button"
            className="btn btn-sm"
            onClick={() => this.setState({ height3: "auto" })}
          >
            auto
          </button>
          <br />
          <button
            type="button"
            className="btn btn-sm"
            onClick={() => this.setState({ height3: "50%" })}
          >
        ...
        <div className="demo-3-wrapper">
          ...
          >
            <div className="demo-content">
              <p>
                It looked serious, but we in California, like everywhere else,
                were not alarmed. We were sure that the bacteriologists would
                find a way to overcome this new germ, just as they had overcome
                other germs in the past. But the trouble was the astonishing
                quickness with which this germ destroyed human beings, and the
                fact that it inevitably killed any human body it entered. No one
                ever recovered. There was the old Asiatic cholera, when you
                might eat dinner with a well man in the evening, and the next
                morning, if you got up early enough, you would see him being
                hauled by your window in the death-cart. But this new plague was
                quicker than that&mdash;much quicker.
              </p>
              <input
                className="form-control"
                type="text"
              ...
              <p>
                The heart began to beat faster and the heat of the body to
                increase. Then came the scarlet rash, spreading like wildfire
                over the face and body. Most persons never noticed the increase
                in heat and heart-beat, and the first they knew was when the
                scarlet rash came out. Usually, they had convulsions at the time
                of the appearance of the rash. But these convulsions did not
                last long and were not very severe. If one lived through them,
                he became perfectly quiet, and only did he feel a numbness
                swiftly creeping up his body from the feet. The heels became
                numb first, then the legs, and hips, and when the numbness
                reached as high as his heart he died. They did not rave or
                sleep. Their minds always remained cool and calm up to the
                ...
                than the body seemed to fall to pieces, to fly apart, to melt
                away even as you looked at it. That was one of the reasons the
                plague spread so rapidly. All the billions of germs in a corpse
