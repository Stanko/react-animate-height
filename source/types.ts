...
type DivWithNoAnimationCallbacks = OmitTypeProps<
  OmitTypeProps<HTMLAttributes<HTMLDivElement>, "onAnimationStart">,
  "onAnimationEnd"
>;

export interface AnimateHeightProps extends DivWithNoAnimationCallbacks {
  "aria-hidden"?: boolean;
